Sequel.migration do
  up do
    # Filet de sécurité : sur certains environnements la migration 005 a été
    # enregistrée comme appliquée sans que la table ait réellement été créée
    # (course SQLite entre les conteneurs app/clock). On la recrée si besoin.
    next if table_exists?(:ticker_mappings)
    ...
    [
      ...
      ['NL0000226223', 'STMicroelectronics',         'STMPA.PA'],
  ...
  down do
    # Pas de rollback : la table reste gérée par la migration 005.
  end
end
